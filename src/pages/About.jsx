...
export default function About() {
  ...
  return (
    <div className=" flex flex-col bg-slate-50 sm:bg-inherit min-h-screen font-alata">
      ...
      <div className=" min-h-screen flex sm:-bottom-[60px] sm:absolute">
        {isMobile ? (
          ...
          <div className=" flex flex-col text-sm text-justify ">
            ...
            <div className="static h-[396px] mt-16">
          ...
          <div className=" flex items-center">
            <img
              ...
              className=" sm:absolute sm:w-[700px] sm:-bottom-[0px] xl:w-[800px]"
            />

            <div className=" flex flex-col items-center justify-between sm:ml-[400px] xl:ml-[500px] xl:gap-20 sm:gap-10">
