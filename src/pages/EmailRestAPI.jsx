...
function EmailRestAPI() {
  ...
  const handleSubmit = async (e) => {
    ...
    const serviceId = "service_lrpuwv8";
    const templateId = "template_dtw07m9";
    const publicKey = "CA02K1F4rsfnf8vtt";
  ...
  return (
    <div className="flex flex-col w-full min-h-screen">
      <div className="flex bg-slate-50">
        <h1 className="flex justify-center items-center bg-[#EE2C3C] w-full p-3 text-slate-100 text-2xl">
          CONTATTI
        </h1>
      </div>
